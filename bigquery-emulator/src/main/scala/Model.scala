...
case class JobReference(projectId: Option[String] = None, jobId: Option[String] = None) derives ReadWriter, Schema
...
case class DatasetReference(projectId: Option[String] = None, datasetId: Option[String] = None)
    derives ReadWriter,
      Schema
...
case class ListDatasets200response(datasets: Option[Seq[Dataset]] = None) derives ReadWriter, Schema
...
case class ListTables200response(tables: Option[Seq[Table]] = None) derives ReadWriter, Schema
...
case class TableSchema(fields: Seq[TableFieldSchema] = Seq.empty) derives ReadWriter, Schema

case class Status(state: Option[StatusState] = None, errorResult: Option[ErrorProto] = None) derives ReadWriter, Schema
